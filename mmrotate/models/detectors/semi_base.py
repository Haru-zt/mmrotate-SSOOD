...
class RotatedSemiBaseDetector(BaseDetector):
    """Base class for semi-supervised detectors. almost the same as the
    original semi_base.py in mmdet, but with some modifications to support
    rotated bounding boxes and burn-in steps.
